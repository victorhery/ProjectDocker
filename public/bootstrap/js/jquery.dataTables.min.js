...
a.sInfoThousands&&(a.sThousands=a.sInfoThousands);(a=a.sDecimal)&&db(a)}function eb(a){A(a,"ordering","bSort");A(a,"orderMulti","bSortMulti");A(a,"orderClasses","bSortClasses");A(a,"orderCellsTop","bSortCellsTop");A(a,"order","aaSorting");A(a,"orderFixed","aaSortingFixed");A(a,"paging","bPaginate");A(a,"pagingType","sPaginationType");A(a,"pageLength","iDisplayLength");A(a,"ing","bFilter");"boolean"===typeof a.sScrollX&&(a.sScrollX=a.sScrollX?"100%":"");"boolean"===typeof a.scrollX&&(a.scrollX=
...
oPaginate:{sFirst:"First",sLast:"Last",sNext:"Suivant",sPrevious:"Précédent"},sEmptyTable:"Aucun élève inscrit",sInfo:"MONTRANT _START_ à _END_ DE _TOTAL_ LIGNES",sInfoEmpty:"Montrant 0 à 0 de 0 Ligne",sInfoFiltered:"(filtré de _MAX_ total en trier)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"AFFICHER _MENU_ LIGNE",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Chercher : ",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aucun enregistrement correspondant trouvé"},oSearch:h.extend({},
