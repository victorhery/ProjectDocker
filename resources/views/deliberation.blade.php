...
<body>
    ...
    <form action="/deliberation_action_ceg" method="POST">
        ...
        <div class="row" id="corps2">
            ...
            <div class="col-6">
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="note_eliminatoire" class="form-control" maxlength="5" onBlur="controlenumero(this)" id="" required>
                </div>
            </div>
