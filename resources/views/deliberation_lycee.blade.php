...
<body>
    ...
    @endif
    <center><B><h1>DELIBERATION AU @foreach ($valeure as $valeure){{ $valeure->Nom_ecol }}@endforeach</h1></B></center><br>
    <form action="/deliberation_action_lycee" method="GET">
        @csrf
        <div class="row" id="corps2">
            ...
            <div class="col-6">
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <label class="input-group-text" for="inputGroupSelect01">Note eliminatoire</label>
                    </div>
                    <input type="text" name="note_eliminatoire" class="form-control" maxlength="6" onBlur="controlenumero(this)"  id="" required>
                </div>
            </div>
