...
<script>
        ...
        function fetch_res() {
            $.ajax({
                url: "{{ route('Cycle') }}",//route dans le web
                type: "GET",
                dataType: "json",
                success: function(data) {
                    var resBody = "";
                ...
                success: function(data) {
                    ...
                    $('#record_table').DataTable({
                        ...
                        "columns": [{
                            ...
                            {
                                "render": function(data, type, row, meta) {
                                    return `<a href="/bulletin_lycee/${row.id }" class="btn btn-sm btn-outline-success">Bulletin de notes</a>
                                    <a href="/update_etudiant_lycee/${row.id }" class="" title='Modifier'><img src="{{ asset('icon/b_edit.png') }}" alt=""></a>
                                    <a href="/delete_etudiant_lycee/${row.id }" class="" onclick="return confirm('Voulez vous vraiment suprimer les information de ${row.Nom_elev } ${row.Prenom_eleve } en classe de ${row.Cycle }. Sur Année scolaire ${row.Annee_scolaire }');" title='Suprimer'><img src="{{ asset('icon/suprimer.png') }}" alt=""></a>`;
                                }
                            }
                        ]
                    });
