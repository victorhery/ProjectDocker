...
return new class extends Migration
{
    ...
    {
        Schema::create('etudiant_lycees', function (Blueprint $table) {
            $table->id();
            ...
            $table->double('Philo_MJ1', 6,NULL);
            // $table->double('NES_MJ1', 6,NULL);
            $table->double('LEV_MJ1', 6,NULL);
            $table->double('TICE_MJ1', 6,NULL);
            ...
            $table->double('Philo_EX1', 6,NULL);
            // $table->double('NES_EX1', 6,NULL);
            $table->double('LEV_EX1', 6,NULL);
            $table->double('TICE_EX1', 6,NULL);
            ...
            $table->double('Philo_MG1', 6,NULL);
            // $table->double('NES_MG1', 6,NULL);
            $table->double('LEV_MG1', 6,NULL);
            $table->double('TICE_MG1', 6,NULL);
            ...
            $table->double('Philo_MJ2', 6,NULL);
            // $table->double('NES_MJ2', 6,NULL);
            $table->double('LEV_MJ2', 6,NULL);
            $table->double('TICE_MJ2', 6,NULL);
            ...
            $table->double('Philo_EX2', 6,NULL);
            // $table->double('NES_EX2', 6,NULL);
            $table->double('LEV_EX2', 6,NULL);
            $table->double('TICE_EX2', 6,NULL);
            ...
            $table->double('Philo_MG2', 6,NULL);
            // $table->double('NES_MG2', 6,NULL);
            $table->double('LEV_MG2', 6,NULL);
            $table->double('TICE_MG2', 6,NULL);
            ...
            $table->double('Philo_MJ3', 6,NULL);
            // $table->double('NES_MJ3', 6,NULL);
            $table->double('LEV_MJ3', 6,NULL);
            $table->double('TICE_MJ3', 6,NULL);
            ...
            $table->double('Philo_EX3', 6,NULL);
            // $table->double('NES_EX3', 6,NULL);
            $table->double('LEV_EX3', 6,NULL);
            $table->double('TICE_EX3', 6,NULL);
            ...
            $table->double('Philo_MG3', 6,NULL);
            // $table->double('NES_MG3', 6,NULL);
            $table->double('LEV_MG3', 6,NULL);
            $table->double('TICE_MG3', 6,NULL);
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('etudiant_lycees');
    }
};
